...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 02. Feb 2018 um 15:58
...
('root', '[{\"db\":\"svf\",\"table\":\"benutzer\"},{\"db\":\"svf\",\"table\":\"beitreten\"},{\"db\":\"svf\",\"table\":\"beitrag\"},{\"db\":\"svf\",\"table\":\"veranstaltung\"},{\"db\":\"svf\",\"table\":\"kategorie\"}]');
...
('root', '2017-12-14 15:04:40', '{\"lang\":\"de\",\"collation_connection\":\"utf8mb4_unicode_ci\"}');
...
-- Datenbank: `svf`
--
CREATE DATABASE IF NOT EXISTS `svf` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `svf`;
...
(49, 'kevin.aulbach@stud.hshl.de', '2c9341ca4cf3d87b9e4eb905d6a3ec45', 'Aulbach', 'Kevin', 'male', 'Soziale Medien und Kommunikationsinformatik', '1995-10-20', 'PB/Screenshot (1).png', NULL),
