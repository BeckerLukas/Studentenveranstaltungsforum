...
<body>
			...
			<div style="float: right;">
				<form action="Ausloggen.php" method="post">
					<table>
						<tbody>
							<tr>
								<th><label for="Begrüßung">Hallo, </label><?php echo begr��ung();?>
							   </th>
							</tr>
							<tr>
								<th>
 ...
 <?php if(profilPr�fung($profilid)==true){ ?>
    <td>
							<button type="button" style="clear: right;">Profil löschen</button>
						</td>
<?php
 ...
 <?php if(profilPr�fung($profilid)==true){ ?>
    <tr>
					...
					<tr>
						<th ALIGN="LEFT"><label for="pass">Passwort bestätigen:</label></th>
						<td><input id="pass" name="pass" type="password"></td>
					</tr>
					<tr>
						<form method="post" enctype="multipart/form-data">

							<th ALIGN="LEFT"><label for="pic">Profilbild ändern:</label></th>
